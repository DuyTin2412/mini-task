...
export class ProjectMembersController {
  ...
  findByProject(@Param('projectId') projectId: string) {
    return this.projectMembersService.findMembersByProjectId(+projectId);
  }

  @Get('invites/:userId')
  findPendingInvites(@Param('userId') userId: string) {
    return this.projectMembersService.findPendingInvitesByUserId(+userId);
  }
